...
$content = '<h3>Our Researchers</h3>
     <div>      	
<p>The research works are conducted by our staff as well as prospective students in School of Engineering and Information Technology.</p>
...
<ul>
    ...
    <li><div class="fran"><h3>Prof. Frances Rosamond</h3> </div>
        ...
        <h4>Research Interests</h4>
			...
			<li>Applications of combinatorial algorithms in voting, election and consensus problems, and in computational biology, medical- and bio-informatics</li>
		
		
		<h4>Current research projects</h4>
		
			<li>Applications of parameterized complexity and algorithms to problems in computational social choice</li>
     ...
     <br/>
      ...
      <li><div class="peter"><h3>Dr. Peter Shaw</h3></div>
        ...
        <h4>Research Interests</h4>
			...
			<li>Predictive analytics and data mining - Predictive analytics combines business intelligence with recent statistical techniques. This research combines this with recent advances in clustering and pattern searching using FPT techniques.</li>
			<li>Infectious disease control using mobile phone technology and cryptographic techniques Combinatorial Algorithms</li>
