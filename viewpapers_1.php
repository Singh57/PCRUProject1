...
<ul id="accordion">
<li><div class="mahadi" >Papers In Progress</div>
   ...
   mysqli_select_db($connect, $databaseName);
     ...
     $query = "SELECT * FROM addnewpaper Where status ='Papers In Progress' ORDER BY title ";
     $result = mysqli_query($connect,$query) ;
        $dataArray = array();
...
<li><div class="mahadi" >Proposed Papers</div>
   ...
   mysqli_select_db($connect, $databaseName);
     ...
     $query = "SELECT * FROM addnewpaper Where status ='Proposed Papers' ORDER BY title ";
     $result = mysqli_query($connect,$query) ;
        $dataArray = array();
